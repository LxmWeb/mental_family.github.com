...
--
-- Host: localhost
-- Generation Time: Mar 12, 2017 at 09:57 PM
...
INSERT INTO `relationship` (`patient_id`, `doctor_id`, `patient_name`, `sex`, `birthday`, `main_suit`, `build_time`, `is_valid`) VALUES
('17816869781', '17816869761', '病人姓名', '男', '1978-09-09', '心情低落，感觉被世界抛弃', '2017-03-11', 1);
...
('17816869729', '111111', '汪汪汪', 2, NULL, NULL, NULL, NULL),
...
--
ALTER TABLE `relationship`
  ADD CONSTRAINT `relationship_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`);
