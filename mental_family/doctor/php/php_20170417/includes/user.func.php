...
{
    $sql = "select patient_id,patient_name,sex,birthday,main_suit from relationship where doctor_id='$doctorId' and is_valid=1";
//  echo get_datas($sql);
...
function send_test($doctorId,$patientId,$testId,$testName,$time){
    $sql = "insert into docPush (doctor_id, patient_id, questionnaireId,questionnaireName, pushTime) values('$doctorId', '$patientId', '$testId','$testName', '$time')";
//  return get_datas($sql);
//	echo $sql;
	insert_datas($sql);
}
